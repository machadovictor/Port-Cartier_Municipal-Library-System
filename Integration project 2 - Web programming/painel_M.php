...
<body>
    ...
    <form method="POST">
        <div id="form_requestdoc">
            <label style="font-size: 14pt;text-align:left;">YOUR MEMBER ID:</label>
    ...
    <?php
        ...
        if (isset($_POST['submit_request'])){
            $sql_requestdoc = "UPDATE documents SET doc_status = 'Requested' WHERE document_id = '$document_id'";
            ...
            echo '<script>alert("Request sent successfully! Please go to reception to complete the loan.");</script>';
        }};
